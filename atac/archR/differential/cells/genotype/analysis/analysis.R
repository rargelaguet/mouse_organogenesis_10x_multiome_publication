...
# I/O
# io$atac_marker_peaks <- file.path(io$basedir,"results/atac/archR/differential/cells/celltype/PeakMatrix/markers/PeakMatrix_markers_upregulated_filt.txt.gz")
...
io$indir <- file.path(io$basedir,sprintf("results/atac/archR/differential/cells/genotype/%s",opts$atac.matrix))
io$outdir <- file.path(io$basedir,sprintf("results/atac/archR/differential/cells/genotype/%s/pdf",opts$atac.matrix))
...
source(here::here("atac/archR/differential/cells/genotype/analysis/load_data.R"))
...
diff_markers.dt <- diff.dt[idx%in%unique(marker_peaks.dt$feature)]
