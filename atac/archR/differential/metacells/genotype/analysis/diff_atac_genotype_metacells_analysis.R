...
# I/O
io$atac_marker_peaks <- file.path(io$basedir,"results/atac/archR/differential/metacells/celltype/PeakMatrix/markers/PeakMatrix_markers_upregulated_filt.txt.gz")
io$indir <- file.path(io$basedir,sprintf("results/atac/archR/differential/metacells/genotype/%s",opts$atac.matrix))
io$outdir <- file.path(io$basedir,sprintf("results/atac/archR/differential/metacells/genotype/%s/pdf",opts$atac.matrix))
...
source(here::here("atac/archR/differential/metacells/genotype/analysis/load_data.R"))
...
print(sprintf("Number of features: %s",length(unique(diff_markers.dt$feature))))
...
peak_annotation.se <- readRDS("/Users/argelagr/data/gastrulation_multiome_10x/test/processed/atac/archR/Annotations/CISBP-Scores.rds")
peak_annotation_filt.se <- peak_annotation.se[unique(diff_markers.dt$feature),]
...
io$virtual_chip_mtx <- file.path(io$basedir,"results/rna_atac/virtual_chipseq/metacells/trajectories/nmp/JASPAR/virtual_chip_matrix.rds")
# io$virtual_chip_mtx <- file.path(io$basedir,"results/rna_atac/virtual_chipseq/pseudobulk/JASPAR/virtual_chip_matrix.rds")
...
# motifmatcher.se <- readRDS("/Users/argelagr/data/gastrulation_multiome_10x/test/processed/atac/archR/Annotations/CISBP-Scores.rds")
motifmatcher.se <- readRDS("/Users/argelagr/data/gastrulation_multiome_10x/test/processed/atac/archR/Annotations/JASPAR-Scores.rds")
...
# ggscatter(to.plot, x="logFC", y="insilico_chip_score") +
...
ggplot(to.plot, aes(x=sig, y=insilico_chip_score, fill=sig)) +
...
virtual_chip.mtx["chr13:56640589-56641189","T"]
assay(motifmatcher.se["chr13:56640589-56641189","TBXT"],"motifMatches")
assay(motifmatcher.se["chr13:56640589-56641189","TBXT"],"motifScores")
...
tmp <- virtual_chip.mtx[da_results.dt$feature,"T"]  
...
# diff_markers.dt[grep("ZForebrain",celltype)] %>% View
