here::i_am("rna/differential/pseudobulk/celltype_genotype/parse_differential_results.R")
...
# args <- list()
# args$diff_results_dir <- file.path(io$basedir,"results/rna/differential/pseudobulk/celltype_genotype")
# args$outfile <- file.path(io$basedir,"results/rna/differential/pseudobulk/celltype_genotype/parsed/diff_expr_results.txt.gz")
## END TEST ##
