here::i_am("rna/differential/pseudobulk/celltype/analysis/define_marker_genes.R")
...
# args <- list()
# args$differential_results <- file.path(io$basedir,"results/rna/differential/pseudobulk/celltype/parsed/diff_expr_results_tfs.txt.gz")
# args$min_score <- 0.75
# args$min_fold_change <- 1.0
# args$fdr <- 0.01
# args$outdir <- file.path(io$basedir,"results/rna/differential/pseudobulk/celltype/parsed"); dir.create(args$outdir, showWarnings = F)
## END TEST ##
