here::i_am("rna_atac/virtual_chipseq_library/pseudobulk/create_virtual_chipseq_library_pseudobulk.R")
...
# args$tf2peak_cor <- file.path(io$basedir,sprintf("results/rna_atac/rna_vs_acc/pseudobulk/TFexpr_vs_peakAcc/%s_cor_TFexpr_vs_peakAcc.rds",args$motif_annotation))
...
# args$outdir <- file.path(io$basedir,"results/rna_atac/virtual_chipseq/pseudobulk/test")
# args$threads <- 1
# args$test <- FALSE
## END TEST ##
